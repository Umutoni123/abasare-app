...
const Digital = () => {
  ...
  return (
    <div className=' h-screen  h-screen '>
      ...
      <button onClick={()=>Navigate('/location' )} className="w-[50px] bg-[white] bg-black  rounded-3xl py-2 tracking-wide pt-3 left mt-5   transition-colors duration-200 transform bg-g-700  hover: bg-whi-600 focus:outline-none focus: bg-black-600">
