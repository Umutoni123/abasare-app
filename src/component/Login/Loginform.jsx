        ...
        <div class="div1"className="relative  flex flex-col justify-center min-h-screen  overflow-hidden"> 
            <div  className="w-[782px] p-14 m-auto  bg-gray-200  rounded-xl shadow-xl text text-black lg:max-w-xl">
                ...
                <form className="mt-6">
                    ...
                    <div className="mt-6">
                        <button  onClick={()=>Navigate('/comform')} className="w-[150px] rounded-xl px-4 py-2 tracking-wide  bg-black    text-white transition-colors duration-200 transform bg-black-700 rounded-md hover: bg-white-600 focus:outline-none  ml-40 focus:bg-black-600">
                            Login
                        </button>
                    </div>
